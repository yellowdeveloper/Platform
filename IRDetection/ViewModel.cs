...
namespace IRDetection
{
    internal class ViewModel : Notifier
    {
        ...
        {
            DebugLogger.Log(3, $"[DEBUG] Points Received !! Set Status to Idle and Process");
